...
const STATUS_COLORS = {
  ...
  'Partial Paid': { color: C.purple,    bg: C.purpleSoft },
...
export default function Invoices() {
  ...
  const stats = useMemo(() => ({
    ...
    totalOutstanding: invoices.filter(i => i.status !== 'Paid' && i.status !== 'Cancelled' && i.doc_type === 'invoice').reduce((s, i) => s + (i.balance_due || 0), 0),
