...
export const SERVICES = [
  ...
  { label: 'Floor Plan',                        group: 'Energy',     cert_type: null,                                expiry_years: null },
  // Fire
  ...
  { label: 'Fire Diagnostics',                  group: 'Fire',       cert_type: null,                                expiry_years: null },
  { label: 'Fire Alarm Installation',           group: 'Fire',       cert_type: null,                                expiry_years: null },
  { label: 'Emergency Lights Certificate (ELC)',group: 'Fire',       cert_type: 'Emergency Lights Certificate (ELC)',expiry_years: 1    },
  { label: 'Emergency Light Installation',      group: 'Fire',       cert_type: null,                                expiry_years: null },
  // Other compliance
